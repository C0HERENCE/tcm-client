...
export function processFeedback(feedbackId, note) {
    return request({
        url: '/api/admin/feedback',
        method: 'post',
        params: {
...
export function getAdminStatistics() {
    return request({
        url: '/api/admin/statistics/admin'
    })
}

export function getForumStatistics() {
    return request({
        url: '/api/admin/statistics/forum'
    })
}
...
export function getAdminRolesById(adminId) {
    return request({
        url: '/api/admin/adminRoles',
        params: {
            adminId
        }
    })
...
export function setRoles(adminId, roles) {
    return request({
        url: '/api/admin/setRoles',
        method: 'post',
        data: {
            adminId: adminId,
            roles: roles
...
export function deleteEs(index, id) {
    return request({
        url: '/api/admin/deleteEs',
        method: 'post',
        params: {
            index, id
        }
